...
// let natureRd2 = placeholderQuestions.filter((cat) => cat.category === "Nature").splice(5,5);
// console.log(natureRd2)
...
// replacing text of nature title with nature    
    natureTitle.textContent = "NATURE";
// fish for nature Li's. used querySelectAll() to get the handy node list.
...
// console log item to see what it does
console.log(item.textContent);
// console log item to say nature
...
populateCategory("computers-title", ".computers", computers)
function populateCategory(elementTitleId, elementQuestionClass, categoryFilteredArray) {
    ...
    questions.forEach((item, index) => {
      // Console Log Item
      item.textContent = categoryFilteredArray[index].question;
...
//     let actualAnswer = nature[1].answer.toLowerCase();
//     if (answer == actualAnswer) {
